          ...
          <div className="w-100 d-flex flex-column align-items-center">
              <div className="d-flex w-75 min-w-300p text-center flex-column align-items-center">
                  ...
                  <p className={"w-60 text-white"}>A virtual reality training game designed to simulate equipment
                      ...
                      time limit.
                      This project was developed as a refresher tool for professionals in refrigeration technology,
                      helping them
                      revisit potential malfunctions and scenarios they may encounter in real systems. It serves as
                      preparation
              ...
              {/*Tooltips*/}
              <div className="container w-75 min-w-300p d-flex align-items-center flex-column">
                  <p className={"h2 text-white mt-5 mb-3 text-center"}>Tooltips</p>
                  <div className={"d-flex flex-row flex-wrap align-content-center"}>
                      <div className={"d-flex flex-column col-xl-6 col-sm-12 col-12"}>
                          <p className={"text-white"}>
                          ...
                          <p className={"text-white"}>
                              Once the pointer was functioning, I integrated the corresponding tooltip text and ensured
              ...
              {/*Follow Target*/}
              <div className="container w-75 min-w-300p d-flex align-items-center flex-column">
                  <p className={"h2 text-white mt-5 mb-3 text-center"}>Follow Target</p>
                  <div className={"d-flex flex-row flex-wrap align-content-center"}>
                      <div className={"d-flex flex-column col-xl-6 col-sm-12 col-12"}>
                          <p className={"text-white"}>
                              During research into the game The Room VR: A Dark Matter, we observed an inventory system
                          ...
                          <p className={"text-white"}>
                              This system includes a variety of adjustable parameters, such as whether the object should
                              face the tracked target,
                              which coordinate space it should operate in, positional offsets, and configurable
                              constraints.
                              These options provide essential flexibility, allowing the system to be adapted for various
                              UI elements—such as
              ...
              {/*Inventory Part 1*/}
              <div className="container w-75 min-w-300p d-flex align-items-center flex-column">
                  <p className={"h2 text-white mt-5 mb-3 text-center"}>Inventory</p>
                  <div className={"d-flex flex-row flex-wrap align-content-center"}>
                      <div className={"d-flex flex-column col-xl-6 col-sm-12 col-12"}>
                          <p className={"text-white"}>
                              While analyzing The Room VR: A Dark Matter, we observed a crucial design decision: key
                              items required for
                              progression are automatically stored in the inventory to prevent players from accidentally
                              discarding them
              ...
              <div className="container w-75 min-w-300p d-flex align-items-center flex-column">
                  <div className={"d-flex flex-row flex-wrap align-content-center"}>
                      <div className={"d-flex flex-column col-xl-6 col-sm-12 col-12"}>
                          <p className={"text-white"}>
                              A display issue emerged where certain items appeared either too large or too small within
                              their inventory slots, due to variations in their original 3D mesh sizes. To resolve this,
                          ...
                          <p className={"text-white"}>
                              ...
                              The actual item itself that needs to go into the inventory when picked up and lastly, the
                              inventory slot that extends
                              from XRBaseInteractable, which manages what inventory item it is holding and which slot is
                              occupied.
                          ...
                          <p className={"text-white"}>
                              ...
                              main problem,
                              which I can refer back to in figure 12, was on how to centre certain objects to the centre
                              of the camera,
                              for the inventory slot. This was a bit hard to figure out, due to the fact that this was a
                              problem that is
              ...
              {/*Sequence*/}
              <div className="container w-75 min-w-300p d-flex align-items-center flex-column">
                  <p className={"h2 text-white mt-5 mb-3 text-center"}>Sequence System</p>
                  <div className={"d-flex flex-row flex-wrap align-content-center"}>
                      <div className={"d-flex flex-column col-xl-6 col-sm-12 col-12"}>
                          <p className={"text-white"}>
                          ...
                          <p className={"text-white"}>
                              ...
                              I integrated the Serializable Callbacks library, which allows for the invocation of events
                              ...
                              to the next tutorial step. A class diagram outlining the structure of this system is shown
                              in Figure 21.
                          </p>
                          <p className={"text-white"}>
                          ...
                          <p className={"text-white"}>
                              ...
                              Toolkit.
                              Conditions needed to account for diverse scenarios: whether an action should occur once or
                              multiple times, and whether progress toward a goal should be visualized for the player.
                          </p>
                          <p className={"text-white"}>
                              The solution involved building a modular condition-checking framework capable of handling
                              these different cases. It was a complex challenge, but I was able to design and implement
                              a
