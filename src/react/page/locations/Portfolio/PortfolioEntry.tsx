...
function PortfolioEntry({asset, last}: PortfolioEntryProps) {
    return (
        <>
            <div className={`w-50 min-w-400p max-w-1000p max-h-300p bg-800 border border-3 ${last ? "" : "border-bottom-0"} border-800 border-secondary d-flex flex-row align-items-start justify-content-start position-relative`}>
